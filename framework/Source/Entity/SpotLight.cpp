...
SpotLight::SpotLight() : Entity(ENTITY_TYPE::SPOT_LIGHT)
{
}

SpotLight::~SpotLight() {}

void SpotLight::Serialize(Json::Value root, unsigned int position)
{
	...
	(*MemoryManager::GetInstance()->ObjectPool)[position].pEn = this;
	(*MemoryManager::GetInstance()->ObjectPool)[position].pEn->mEntityName = "SpotLight";
	this->runtime = false;
