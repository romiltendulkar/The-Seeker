...
void Platform::HandleEvent(Event* pEventToHandle)
{
	if (pEventToHandle)
	{
		if (pEventToHandle->mEventType == EVENT_TYPE::COLLIDE_EVENT)
		{
			...
			if (b2 == ENTITY_TYPE::PLATFORM)
			{
				if (b1 == ENTITY_TYPE::EXPLODER || b1 == ENTITY_TYPE::SHOOTER || b1 == ENTITY_TYPE::BOSS2 || b1 == ENTITY_TYPE::BOSS1 || b1 == ENTITY_TYPE::CHARGER ||
			...
			else if (b1 == ENTITY_TYPE::PLATFORM)
			{
