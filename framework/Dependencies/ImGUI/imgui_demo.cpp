...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // Most "big" widgets share a common mWidth settings by default.
    //ImGui::PushItemWidth(ImGui::GetWindowWidth() * 0.65f);    // Use 2/3 of the space for widgets and 1/3 for labels (default)
    ImGui::PushItemWidth(ImGui::GetFontSize() * -12);           // Use fixed mWidth for labels (by passing a negative value), the rest goes to widgets. We choose a mWidth proportional to our font size.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            ImGui::SliderFloat("Wrap mWidth", &wrap_width, -20, 600, "%.0f");
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // If you decided that ImTextureID = MyEngineTexture*, then you can pass your MyEngineTexture* pointers to ImGui::Image(), and gather mWidth/mHeight through your own functions, etc.
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // Typically we would use ImVec2(-1.0f,0.0f) or ImVec2(-FLT_MIN,0.0f) to use all available mWidth,
        // or ImVec2(mWidth,0.0f) for a specified mWidth. ImVec2(0.0f,0.0f) uses ItemWidth.
...
static void ShowDemoWindowLayout()
{
    ...
    {
        // Use SetNextItemWidth() to set the mWidth of a single upcoming item.
        // Use PushItemWidth()/PopItemWidth() to set the mWidth of a group of items.
        static float f = 0.0f;
        ImGui::Text("SetNextItemWidth/PushItemWidth(100)");
        ImGui::SameLine(); HelpMarker("Fixed mWidth.");
        ImGui::SetNextItemWidth(100);
        ImGui::DragFloat("float##1", &f);

        ImGui::Text("SetNextItemWidth/PushItemWidth(GetWindowWidth() * 0.5f)");
        ImGui::SameLine(); HelpMarker("Half of window mWidth.");
        ImGui::SetNextItemWidth(ImGui::GetWindowWidth() * 0.5f);
        ImGui::DragFloat("float##2", &f);

        ImGui::Text("SetNextItemWidth/PushItemWidth(GetContentRegionAvail().x * 0.5f)");
        ImGui::SameLine(); HelpMarker("Half of available mWidth.\n(~ right-cursor_pos)\n(works within a column set)");
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Checkbox("Tree nodes", &show_tree_nodes);    // Will grow contents size and display highlight over full mWidth
...
static void ShowDemoWindowColumns()
{
    ...
    ImGui::SameLine();
    HelpMarker("Disable the indenting of tree nodes so demo columns can use the full window mWidth.");
    if (disable_indent)
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // If your items are of variable size you may want to implement code similar to what ImGuiListClipper does. Or split your data into fixed mHeight items to allow random-seeking into your list.
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        else
        {
            ...
            // Using ImGuiListClipper requires A) random access into your data, and B) items all being the  same mHeight,
